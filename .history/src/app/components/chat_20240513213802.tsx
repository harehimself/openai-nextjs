...
export function Chat() {
  ...
  return (
    <main className="flex flex-col w-full h-screen max-h-dvh bg-background">
      <header className="p-4 border-b w-full max-w-3xl mx-auto flex items-center"> {/* Add flex items-center */}
        <Image src={LogoImage} alt="Logo" width={30} height={30} className="mr-2" /> {/* Add the Image component */}
        <h1 className="text-2xl font-bold">HareChat</h1>
      </header>
